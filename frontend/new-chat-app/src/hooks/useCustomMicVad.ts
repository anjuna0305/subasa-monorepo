...
import { getDefaultReactRealTimeVADOptions, ReactRealTimeVADOptions } from "@ricky0123/vad-react";
import { DEFAULT_MODEL, MicVAD, RealTimeVADOptions } from "@ricky0123/vad-web";
...
export function useCustomMicVAD(options: Partial<ReactRealTimeVADOptions>) {
